...
def plot_and_save_results(
    ...
    if Path(model_path).exists():
        ...
        logging.warning(f"Model weights not found at {model_path}. Trying uninitialized model.")
    ...
    inferer = SlidingWindowInferer(roi_size=(16, 128, 128), sw_batch_size=4, overlap=0.25)
